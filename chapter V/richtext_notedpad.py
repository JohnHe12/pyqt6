...
class MainWindow(QMainWindow):
    ...
    def initializeUI(self):
        ...
        self.setWindowTitle("Rich Text Motpad GUI")
    ...
    def createMenu(self):
        ...
        #To add a divider between categories in a menu, use addSeparator(). 
    ...
    def saveToFile(self):
        ...
        if file_name.endswith(".txt"):
            #QTextEdit.toPlainText() is used to convert the text to plain text
